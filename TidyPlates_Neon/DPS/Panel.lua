...
local function CreateInterfacePanel( Name, Title, Parent, VariableTarget )  
	...
	-- Loose Units Scale
	panel.ScaleDanger = PanelHelpers:CreateSliderFrame(Name.."_ScaleLoose", Column1, "Масштаб при угрозе:", 1.5, 1, 2, .1)
	...
	panel.AggroDesc:SetText("Цвет угрозы:")
	...
	-- Loose Units
	panel.AggroSafeColor = PanelHelpers:CreateColorBox(Name.."_AggroSafeColor", Column1, "Безопасно", 0, .5, 1, 1)
	panel.AggroSafeColor:SetPoint("LEFT", 24)
	panel.AggroSafeColor:SetPoint("TOP", panel.AggroDesc, "BOTTOM", 0,-8)

	-- Tanked Units
	panel.AggroDangerColor = PanelHelpers:CreateColorBox(Name.."_AggroDangerColor", Column1, "Опасность", 0, .5, 1, 1)
...
-- Login
DPSPanel = CreateInterfacePanel( "TidyPlatesNeonDPS", "ДПС", "Tidy Plates: Neon", TidyPlatesNeonDPSVariables ) 
